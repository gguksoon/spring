...
public class User {
	...
	private String realfilename;// 물리 파일명(저장된 파일명)
	private String realfilename2;// 물리 파일명(저장된 파일명)
	
	public User() { }
	
	public User(String userId, String pass, String userNm, String alias, Date reg_dt) {
		super();
		this.userId = userId;
		this.pass = pass;
		this.userNm = userNm;
	...
	public User(String userId, String pass, String userNm, String alias, Date reg_dt, String addr1, String addr2,
			String zipcode, String filename, String realfilename, String realfilename2) {
		this.userId = userId;
		this.pass = pass;
		this.userNm = userNm;
		this.alias = alias;
